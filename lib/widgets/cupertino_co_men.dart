...
///
/// When open, the [CupertinoContextMenu2M] shows the child, or the widget returned
...
/// unconstrained.
///
/// When closed, the CupertinoContextMenu2M simply displays the child as if the
/// CupertinoContextMenu2M were not there. Sizing and positioning is unaffected.
...
///
/// {@tool dartpad}
/// This sample shows a very simple CupertinoContextMenu2M for an empty red
...
class CupertinoContextMenu2M extends StatefulWidget {
  ...
  /// The widget that can be "opened" with the [CupertinoContextMenu2M].
  ///
  /// When the [CupertinoContextMenu2M] is long-pressed, the menu will open and
  ...
  /// doesn't size itself.
  ///
  /// When the [CupertinoContextMenu2M] is "closed", this widget acts like a
  ...
  /// the CupertinoContextMenu2M opens, and from 1 to 0 when it closes, and it can
  ...
  /// CupertinoContextMenu2M is closed.
  ///
  /// {@tool snippet}
  ///
  ...
  /// rounded corners. The larger size of the open CupertinoContextMenu2M allows
  ...
  /// into view as the CupertinoContextMenu2M is opened. The preview is swapped in
  ...
  ///   // aspect ratio when the CupertinoContextMenu2M is animating its preview
  ///   // widget open and closed.
  ///   previewBuilder: (BuildContext context, Animation<double> animation, Widget child) {
  ///     return FittedBox(
  ///       fit: BoxFit.cover,
  ///       // This ClipRRect rounds the corners of the image when the
  ///       // CupertinoContextMenu2M is open, even though it's not rounded when
  ...
  @override
  State<CupertinoContextMenu2M> createState() => _CupertinoContextMenu2MState();
}

class _CupertinoContextMenu2MState extends State<CupertinoContextMenu2M> with TickerProviderStateMixin {
...
// The open CupertinoContextMenu2M modal.
class _ContextMenuRoute<T> extends PopupRoute<T> {
  ...
  // The Rect of the child at the moment that the CupertinoContextMenu2M opens.
...
// The menu that displays when CupertinoContextMenu2M is open. It consists of a
// list of actions that are typically CupertinoContextMenu2MActions.
